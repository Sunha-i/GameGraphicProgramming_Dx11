...
{
    std::unique_ptr<Game> game = std::make_unique<Game>(L"2020105610 박선하 LAB 09");
    ...
    std::shared_ptr<PointLight> pointLight = std::make_shared<PointLight>(XMFLOAT4(-5.0f, 5.0f, -5.0f, 1.0f), color);
